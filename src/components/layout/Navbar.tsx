...
export function Navbar() {
  ...
  const showGlass = isDesktop || scrollY > 50;
    ...
    <>
      <header
        className={cn(
          ...
          showGlass ? "glass border-b border-white/5" : "bg-transparent",
        )}
      >
        <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <Link
              href="/"
              className="flex items-center md:pl-5"
              aria-label="Mahendra Singh Puniya — home"
            >
