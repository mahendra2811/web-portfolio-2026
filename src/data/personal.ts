export const personalInfo = {
  ...
  bio: {
    short: "Full-stack developer specializing in React, Next.js, and modern web technologies. Building performant, accessible, and beautiful digital experiences.",
    long: "I'm Mahendra Singh Puniya, a passionate full-stack developer with a B.Tech in Computer Science from IIIT Dharwad. I specialize in building high-performance web applications using React.js, Next.js, and the modern JavaScript ecosystem. With experience at Primathon as both an intern and associate developer, I've delivered measurable impact — reducing load times by 40%, achieving 90%+ test coverage, and cutting API latency by 35%. When I'm not coding, I'm solving DSA problems (500+ and counting) or exploring new technologies. I believe great software is an intersection of engineering excellence and thoughtful design."
  }
} as const;
...
export const education = [
  {
    ...
    duration: "2020 – 2024",
    cpi: "7.0",
    coursework: ["Data Structures & Algorithms", "Database Management Systems", "Operating Systems", "Artificial Intelligence", "Machine Learning", "Computer Networks"]
  }
] as const;
...
export const experience = [
  {
    ...
    location: "India",
    description: "Building and maintaining scalable web applications using React.js and Next.js ecosystem. Leading frontend development initiatives with focus on performance optimization and code quality.",
    responsibilities: [
    ...
    techStack: ["React.js", "Next.js", "TypeScript", "MongoDB", "PostgreSQL", "JWT", "Firebase Auth", "GitHub Actions", "Vercel", "AWS", "Jest", "React Testing Library"],
    metrics: [
  ...
  },
  {
    ...
    location: "India",
    description: "Contributed to frontend development projects in an Agile environment, building responsive UI components and data visualizations.",
    responsibilities: [
...
export const achievements = [
  { title: "500+ DSA Problems", description: "Solved on LeetCode and GeeksForGeeks", icon: "Code", link: "#" },
  { title: "NCC 'B' Certificate", description: "National Cadet Corps certified", icon: "Award", link: null }
] as const;
