...
export const projects: Project[] = [
...

  {
    ...
    year: "2026",
    highlights: [
      "4 flagships + 23 utility tools, all in v1",
      "100% on-device — files never leave your phone",
      "Biometric App-Lock + encrypted Vault (AndroidKeyStore)",
      "Sensitive-data detector + SAF backup",
      "Multi-module Gradle monorepo, MVVM + Hilt",
      "5 Indic locales + Devanagari OCR",
    ],
    role: "Solo Developer (Self) + Architect",
    duration: "2026-04 to present",
    problem:
      "Indians need PDF tools but the top apps (CamScanner, Adobe) shove ads, force accounts, and upload sensitive Aadhaar/PAN/marksheet/exam-form documents to foreign servers — violating both user trust and the DPDP Act 2023 spirit.",
    solution:
      "Native Android, Compose-first, 100% on-device PDF hub. No ads ever, no account, no upload. Made-in-India branding with humble founder narrative.",
    outcome:
      "v1 build feature-complete; signed AAB submitted to Play Console internal testing. Privacy policy hosted at pooniya.com/privacy/pdfnest.",
    tags: ["android", "kotlin", "compose", "pdf", "on-device", "privacy-first", "indic", "dpdp"],
    sourcePath: "a_APP/5. pdfNest/",
  },

  {
    ...
    featured: true,
    liveUrl: "https://aqualogica.in",
    githubUrl: "#",
    // githubUrl: "https://github.com/primathontech/aqualogica",
    status: "Live",
    year: "2025",
    highlights: [
    ...
    role: "Frontend Developer @ Primathon",
    duration: "2025",
    problem:
      "Beauty brand needed a modern, performant headless storefront with visual page building, GoKwik checkout, and multi-language support — without rebuilding for every content change.",
    solution:
      "Next.js 15 RSC-first storefront with Shopify integration, a visual widget-registry editor, multi-level caching, and GoKwik for conversion optimization.",
    tags: [
      "nextjs",
      "shopify",
      "headless-commerce",
...

  {
    ...
    longDescription:
      "Storefront platform for Plixkids built at Primathon on Next.js 14. Unlike the Shopify-centric storefronts, Plixkids integrates a custom commerce backend for cart and orders while retaining the visual page builder (widget registry + editor submodule) and GoKwik QA checkout pipeline. Supports product-page video (feature/video-app), tag-based release lifecycle management, multi-language via next-intl, and A/B testing. Shares the same zero-downtime Blue-Green deployment strategy on AWS EC2.",
    techStack: [
      "Next.js 14",
      "TypeScript",
      "Tailwind CSS 3",
    ...
    category: "E-commerce / Headless",
    featured: false,
    liveUrl: "https://store.plixkids.com/",
    githubUrl: "#",
    // githubUrl: "https://github.com/primathontech/plixkids",
    status: "In Development",
    year: "2025",
    highlights: [
    ...
    duration: "2025",
    problem:
      "Kids products brand needed a flexible headless storefront with a custom (non-Shopify) backend and rich media (video) on product pages.",
    solution:
      "Next.js 14 storefront with a commerce abstraction layer for custom backend, GoKwik integration, video product pages, and a tag-based release system.",
    tags: [
      "nextjs",
      "headless-commerce",
      "custom-backend",
...

  {
    ...
    category: "E-commerce / Headless",
    featured: false,
    liveUrl: "https://store.wellversed.in/",
    githubUrl: "#",
    status: "In Development",
    year: "2025",
    highlights: [
    ...
    duration: "2025",
    problem:
      "Merchants needed to build and customize storefronts without deep technical knowledge — and onboarding a new merchant required too much developer time.",
    solution:
      "Visual editor + template registry + section widgets so non-technical teams edit templates in real time while developers control component structure.",
    tags: [
      "nextjs",
      "shopify",
      "hydrogen",
...

  {
    ...
    duration: "2025",
    problem:
      "Elderly-care company needed a marketing site for service discovery and a staff-only admin tool for enquiry triage — with separate deployment without a separate design system.",
    solution:
      "Two-app Next.js monorepo sharing Tailwind + shadcn tokens, deployed independently so public and admin concerns stay cleanly separated.",
    tags: [
      "nextjs",
      "healthcare",
      "eldercare",
...

  {
    ...
    role: "Full-stack Developer @ Primathon",
    duration: "2025",
    problem:
      "Indian SMBs and NGOs need form + document management without paying for expensive SaaS platforms like Google Workspace + DocuSign.",
    solution:
      "Full-stack web app with form submission, Cloudinary document storage, member management, and in-browser PDF viewing — all in a unified dashboard.",
    tags: [
      "nextjs",
      "react19",
      "express",
...

  {
    ...
    techStack: [
      ...
      "expo-sqlite",
      "expo-secure-store",
      "expo-speech-recognition (on-device)",
